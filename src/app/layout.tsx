  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="francisco-arenas-psicologo";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Francisco Arenas Psicólogo Córdoba"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="francisco-arenas-psicologo"
          data-primary-color="#9c8779"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="francisco-arenas-psicologo";
